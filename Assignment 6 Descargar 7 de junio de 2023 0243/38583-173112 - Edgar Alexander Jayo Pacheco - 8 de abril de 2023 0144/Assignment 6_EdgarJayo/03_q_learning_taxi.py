# -*- coding: utf-8 -*-
"""03 Q-Learning - Taxi.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1pK6jV0r-LMXq0bUMVmtAYxiyN9OsJUVI
...
## Parte 03 - Ambiente Taxi
"""

import numpy as np

class gridWorldGame:
  def __init__(self, width, height, start, rewards, step_cost):
    self.width = width
    self.height = height
    self.start = start
    self.i = start[0]
...
rewards = {(0, 0): 5, (0, 4): 5, (4, 0): 5}

# Penalidad por un paso indebido
step_cost = -10
...
gw = gridWorldGame(cols, rows, start_state, rewards, step_cost)
