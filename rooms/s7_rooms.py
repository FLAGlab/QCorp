...
height = 11
width = 11
gridworld = [[(" ",-0.5) for _ in range(width)] for _ in range(height)]   
blank_spots= [(0,5),(1,5),(3,5),(4,5),(5,5),(6,5),(7,5),(9,5),(10,5),(5,0),(5,1),(5,3),(5,4),(5,5),(5,6),(5,7),(5,9),(5,10)]
positive_reward_spots_gridworld =[(0,2)]
negative_reward_spots_gridworld =[]
...
for positive in positive_reward_spots_gridworld:
    gridworld[positive[0]][positive[1]]=(" ",10)
